...
const content = {
  uk: {
    ...
    bottomText: (
      <>
        Ми саме ті екстрасенсори, які здатні дихати, бачити, чути і відчувати на
        глибині 11 тисяч метрів. Ми занурюємось туди, щоб віднайти серце твого
        бренду.
      </>
    ),
...

      {
        ...
        description: (
          <>
            <span>ВІДДІЛ ПОГЛЯДУ</span>
            <br />
            Суперсила Тані - з величезного обʼєму інфо про бізнес клієнта, а
            також аналітики ринку, вибрати головну родзинку і зробити з неї
            символ, що дуже просто передасть усе те складне. А ще Таня створює
            сайти, що вантажаться швидше, ніж ви встигаєте згадати пароль.
...

      {
        ...
        description: (
          <>
            ...
            тремтливий настрій, унікальний жест.
          </>
        ),
      },

      {
        ...
        description: (
          <>
            ...
            <br />
            Генерує ідеї швидше, ніж ми встигаємо записувати. У неї всередині
            або маленький всесвіт, або великий портал. Ми досі уточнюємо.
          </>
        ),
      },

      {
        ...
        description: (
          <>
            <span>ВІДДІЛ ПОГЛЯДУ</span>
            <br />
            Створює стилі і справжні картини від руки, а ще персонажів і світи,
            які хочеться обіймати. Навіть якщо це дракон з поганим настроєм.
          </>
        ),
      },
    ],
  ...
  en: {
    title: "non-superficials",
    bottomText: (
      <>
        We are the extrasensors who are able to breathe, see, hear, and feel at
        the depth of 11,000 meters. We dive to such a depth to find the heart of
        your brand.
      </>
    ),
  ...
  return (
    <section className="team-section">
      <div className="container">
        <div className="team-section-title">{t.title}</div>

        {width && width < 600 && (
          <div className="team-section-grid-bottom-text">{t.bottomText}</div>
        )}
